...
var s_account="lgein" 	// Report Suite ID
...
s.linkInternalFilters="javascript:,http://www.lge.com/in,http://in.lge.com,http://www.lgindia.com"
...
if(!s.prop5) s.prop5=s.getQueryParam('searchVal.keyword');   // when search keyword can be captured from query parameter
if(s.prop1){ 
	s.eVar7=s.prop5; 
...
/* Copy props to eVars */
if(s.channel&&!s.eVar3) s.eVar3=s.channel; 		// Site Section
if(s.channel&&!s.prop3) s.prop3=s.channel; 		// Site Section
if(s.prop1&&!s.eVar1) s.eVar1=s.prop1; 			// Site Language Code
if(s.prop2&&!s.eVar2) s.eVar2=s.prop2; 			// Site Country Code
if(s.prop4&&!s.eVar4) s.eVar4=s.prop4; 			// Sub Section
if(s.prop5&&!s.eVar5) s.eVar5=s.prop5; 			// Sub Sub Section
if(!s.hier1) s.hier1=s.pageName;         		// Site Hierarchy
}
